	...
	<body>
		...
		<div class="container">
			<div id="admin-header-left2">
				...
				<br/><br/><br/><br/>
				<form action="add_client_final.php" method="post">
					<div id="left">
					...
					<div id="right">
						...
						<input type="text" name="ship" class="form" /><br/><br/>
						&nbsp &nbsp &nbsp &nbsp &nbsp City<br/>
						<input type="text" name="city" class="form" /><br/><br/>
						&nbsp &nbsp &nbsp &nbsp &nbsp State<br/>
						<input type="text" name="state" class="form" /><br/><br/>
						&nbsp &nbsp &nbsp &nbsp &nbsp ZIP Code<br/>
						<input type="text" name="zip" class="form" /><br/><br/>
