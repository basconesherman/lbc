	...
	<body>
		...
		<div class="container">
			<div id="admin-header-left2">
				<h2 class="admin-title">&nbsp Upload Design</h2>
				...
				<div class="section group">
					<div class="">
					<br/><br/><br/>
						<h2 class="medium left" style="display:inline;margin:0 0 0 20px;">Needs Design Upload</h2>
								...
								while($row = mysql_fetch_array($result))
									{
										...
										echo '<td><div align="center"><a href="upload_final.php?id='.$row['id'].'" title="Upload PDF Design">Upload Design</a></div></td>';
										echo '</tr>';
									}
								?> 
							</tbody>
				...
				<div class="section group">
					<div class="">
					<br/><br/>
						<h2 class="medium left" style="display:inline;margin:0 0 0 20px;">Orders With Pending Approval</h2>
						<input type="text" id="filter"  placeholder="Type text to filter result..."/>
						<table cellpadding="1" cellspacing="1" id="resultTable">
							<thead>
								<tr>
							...
							<tbody>
								<?php
								include('../connect.php');
								$result = mysql_query("SELECT * FROM tblorders WHERE design_approval='Waiting for Approval'");
								while($row = mysql_fetch_array($result))
									{
										echo '<tr class="record">';
										echo '<td><div align="left">'.$row['id'].'</div></td>';
				...
				<div class="section group">
					<div class="">
					<br/><br/>
						<h2 class="medium left" style="display:inline;margin:0 0 0 20px;">Approved Orders</h2>
						<input type="text" id="filter"  placeholder="Type text to filter result..."/>
						<table cellpadding="1" cellspacing="1" id="resultTable">
							<thead>
								<tr>
							...
							<tbody>
								<?php
								include('../connect.php');
								$result = mysql_query("SELECT * FROM tblorders WHERE design_approval='Approved'");
								while($row = mysql_fetch_array($result))
									{
										echo '<tr class="record">';
										echo '<td><div align="left">'.$row['id'].'</div></td>';
