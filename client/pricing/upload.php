...
<html>
	...
	<body>
		<div class="container">
			...
			<div id="paper-box" style="height:880px;">
				<div class="content-grid">
					<?php
						...
						echo "});</script>";
						$today = date("m.d.y"); 
						mysql_query("INSERT INTO tblorders (id, date, email, quantity, item, proof, status, shipping, design_approval)
						VALUES ('$id','$today','$user_email','$quantity','Letterpress/BCard','---','Confirmed', '$user_shipping','Needs Design')");
					?>
					<br/><br/>
					...
					<div class="section group">
						...
						<div id="upload-right" class="col span_1_of_2">
							<form action="save_upload.php?id=<?php echo $id;?>" method="post" enctype="multipart/form-data">
								<input name="filename" type="text" style="display:none;" value="<?php echo $id; ?>"/>
								<a href="<?php echo '../../upload/'.$id.'.pdf';?>" target="_blank"><img id="preview-image" src="images/preview.png" alt="Preview"/></a>
								<div id="upload-file-container" class="upload">
								  <strong>Upload Design:</strong> <input id="attach" type="file" name="pdf_document" />
								  <input id="admin-button" name="upload_pdf" style="margin:15px 0 0 179px;cursor:pointer;" type="submit" value="SUBMIT" />
								</div>
							</form>
						</div>
					</div>
