...
<html>
	<head>
		...
		<?php include '../js/extras_calcu.php';?>
			...
			<div id="paper-box">
				<form action="extras-process.php" method="post">
					...
					<div class="content-grid">
						...
						<br/><br/>
						<div id="extras-box" style="margin-left:20px;">
							<div class="section group" style="margin-left:55px;">
					...
					<div class="content-grid">
						...
						<div id="extras-box">
							...
							<div id="edging-hidden" class="section group deactivated" style="margin-left:55px;">
								<div class="col span_1_of_2">
									<div  class="col span_1_of_12">
				...
				<img class="quote" style="margin-left:350px;" src="images/extras-quote.png" width="285px" height="81px">
