...
<html>
	<head>
		...
		<script src="../js/paper_calcu.js"></script>
	</head>
	...
	<body>
		<div class="container">
			...
			<?php include '../library/navigation2.php';?>
			<div class="content-grid">
				...
				<div id="tabs">
					<ul>
						...
						<li id="total"><center><p id="totalValue">$0.00</p></center></li>
					</ul>
				</div>
			</div>
			<div id="paper-box">
				<form id="pricing-tab-" action="paper-process.php" method="post">
					...
					<div class="content-grid">
						<div class="title">
							<p id="title" style="text-align:left;font-size:26pt;margin-left:10px;">WHAT WOULD YO LIKE TO ORDER?</p>
							<select id="drop1">
